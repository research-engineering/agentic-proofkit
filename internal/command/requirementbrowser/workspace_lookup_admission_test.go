...
func TestWorkspaceLookupAdmissionRejectsWithoutDisclosureOrSessionMutation(t *testing.T) {
	...
	for _, item := range []struct {
		...
		{"coverage", map[string]any{"searchText": sentinel}},
		{"coverage", map[string]any{sentinel: true}},
		{"coverage", map[string]any{"nodeId": "spec.unknown"}},
		{"coverage", map[string]any{"ownerId": "owner.unknown"}},
		{"coverage", map[string]any{"lifecycleState": "invented"}},
