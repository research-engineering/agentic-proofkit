...
var commandCoverageRoutes = map[string][]commandCoverageRoute{
	...
	"requirement-source-transition":            {requiredInputAdmissionRoute, packageFalsifierRoute("internal/command/requirementsourcetransition/requirementsourcetransition_test.go", "TestBuildRejectsLifecycleTransitionWithoutNewEvidence", semanticRouteProof("requirementsourcetransition.build_rejects_lifecycle_transition_without_new_evidence"), "Requirement source transition must reject lifecycle state changes without new evidence.")},
	...
	"spec-overview-claims":                     {requiredInputAdmissionRoute, packageFalsifierRoute("internal/command/specoverviewclaims/specoverviewclaims_test.go", "TestBuildRejectsUncitedDurableClaim", semanticRouteProof("specoverviewclaims.build_rejects_uncited_durable_claim"), "Spec overview claim admission must reject durable overview claims that do not cite requirement records.")},
