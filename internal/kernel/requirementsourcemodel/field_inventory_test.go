...
var inputFieldManifestIDs = map[string][]string{
	...
	"Draft.SourceNonClaims":                   {"source.nonClaims"},
	...
	"MetadataFields.NonClaims":                {"metadata.nonClaims"},
	"MetadataFields.ExternalNonClaimRefs":     {"metadata.externalNonClaimRefs"},
	"MetadataFields.ProofBindingRefs":         {"metadata.proofBindingRefs"},
