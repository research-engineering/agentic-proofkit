...
func validateRequiredBindingWitnessSelectors(bindings bindingFile) error {
	...
	required := map[inventoryKey][]string{
		...
		{"REQ-PROOFKIT-WORKFLOW-007", "proofkit.agent-workflow.native-evidence-guidance-slot-closure"}:    {"TestGuidanceReferenceIsCompactAndOwnerBound", "TestGuidanceSlotPredicates"},
		...
		{"REQ-PROOFKIT-WORKFLOW-010", "proofkit.agent-workflow.catalog-prerequisite-causality"}:           {"TestWorkflowStatePredicates"},
	...
	requiredPaths := map[inventoryKey]string{
		...
		{"REQ-PROOFKIT-WORKFLOW-010", "proofkit.agent-workflow.catalog-prerequisite-causality"}:                        "internal/command/changeworkflowplan/state_test.go",
		...
		{"REQ-PROOFKIT-PACKAGE-002", "proofkit.package-boundary.adoption-materialization-output-root-witnesses"}:       "internal/app/adoption_materialization_command_test.go",
		...
		{"REQ-PROOFKIT-QUALITY-004", "proofkit.supply-chain-quality.adoption-materialization-cli-abi"}:                 "internal/app/adoption_materialization_command_test.go",
		...
		{"REQ-PROOFKIT-QUALITY-023", "proofkit.supply-chain-quality.release-closeout-npm-byte-admission"}:              "internal/tools/releasecloseoutinput/main_test.go",
		...
		{"REQ-PROOFKIT-SPEC-033", "proofkit.spec-proof-core.repository-transaction-output-relations"}:                  "internal/kernel/repositorytransaction/output_admission_test.go",
		{"REQ-PROOFKIT-SPEC-033", "proofkit.spec-proof-core.repository-transaction-cleanup-state-matrix"}:              "internal/kernel/repositorytransaction/state_machine_test.go",
		{"REQ-PROOFKIT-SPEC-033", "proofkit.spec-proof-core.repository-transaction-filesystem-portable-path-identity"}: "internal/kernel/repositorytransaction/plan_test.go",
