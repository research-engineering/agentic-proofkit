...
func requiredBindingWitnessInventory() map[inventoryKey]requiredInventoryEntry {
	return map[inventoryKey]requiredInventoryEntry{
		...
		{"REQ-PROOFKIT-WORKFLOW-019", "proofkit.agent-workflow.integration-lifecycle-cli"}: {
			...
			selectors:          []string{"TestIntegrationApplyCLI", "TestIntegrationLifecycleInvocationAndPresentation", "TestIntegrationPlanCLI", "TestIntegrationRecoverCLI"},
		},
		{"REQ-PROOFKIT-WORKFLOW-019", "proofkit.agent-workflow.integration-lifecycle-npm-carrier"}: {
			commandIDs:         []string{"proofkit.go-test"},
			environmentClasses: []string{"local-go"},
			witnessPath:        "internal/tools/packageverify/workflow_carrier_test.go",
			selectors:          []string{"TestInstalledNPMWorkflowCarrierClosure"},
		},
		{"REQ-PROOFKIT-WORKFLOW-019", "proofkit.agent-workflow.integration-lifecycle-pair-recognition"}: {
			commandIDs:         []string{"proofkit.go-test"},
			environmentClasses: []string{"local-go"},
			witnessPath:        "internal/command/agentintegration/lifecycle_test.go",
			selectors:          []string{"TestLifecycleBaselineCanonicalAdmission", "TestLifecyclePairRecognition"},
		},
		{"REQ-PROOFKIT-WORKFLOW-019", "proofkit.agent-workflow.integration-lifecycle-version-edge"}: {
			commandIDs:         []string{"proofkit.go-test"},
			environmentClasses: []string{"local-go"},
			witnessPath:        "internal/app/integration_version_edge_test.go",
			selectors:          []string{"TestManagedIntegrationVersionEdgeClosesDeclaredPublicABIDelta"},
		},
		{"REQ-PROOFKIT-WORKFLOW-019", "proofkit.agent-workflow.integration-lifecycle-version-edge-mutants"}: {
			commandIDs:         []string{"proofkit.go-test"},
			environmentClasses: []string{"local-go"},
			witnessPath:        "internal/app/public_abi_mutation_test.go",
			selectors:          []string{"TestManagedIntegrationVersionEdgeRejectsUndeclaredPublicABIDrift"},
		},
		{"REQ-PROOFKIT-WORKFLOW-019", "proofkit.agent-workflow.integration-lifecycle-wheel-carrier"}: {
			commandIDs:         []string{"proofkit.go-test"},
			environmentClasses: []string{"local-go"},
			witnessPath:        "internal/tools/pythonpackage/workflow_carrier_test.go",
			selectors:          []string{"TestInstalledPythonWorkflowCarrierClosure"},
		},
		{"REQ-PROOFKIT-WORKFLOW-019", "proofkit.agent-workflow.integration-lifecycle-whole-operation"}: {
			commandIDs:         []string{"proofkit.go-test"},
			environmentClasses: []string{"local-go"},
			witnessPath:        "internal/command/agentintegration/lifecycle_test.go",
			selectors:          []string{"TestLifecycleAppliesReplaysAndPreservesNeighbors", "TestLifecycleRejectsChangedIdentityAndLocalEdits"},
		},
		{"REQ-PROOFKIT-WORKFLOW-019", "proofkit.agent-workflow.integration-recover-busy-stream"}: {
			commandIDs:         []string{"proofkit.go-test"},
			environmentClasses: []string{"local-go"},
			witnessPath:        "internal/app/agent_integration_lifecycle_unix_test.go",
			selectors:          []string{"TestIntegrationRecoverBusyCLIIsClassified"},
		},
		{"REQ-PROOFKIT-WORKFLOW-019", "proofkit.agent-workflow.integration-update-effect-oracle"}: {
			commandIDs:         []string{"proofkit.go-test"},
			environmentClasses: []string{"local-go"},
			witnessPath:        "internal/tools/workflowsmoke/integration_lifecycle_mutation_test.go",
			selectors:          []string{"TestInstalledLifecycleWitnessRejectsUpdateWithoutEffects"},
		},
