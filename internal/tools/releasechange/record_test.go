...
var currentMigrationSteps = []string{
	...
	"Use a repository-owned native witness for .cts, computed enum initializers, or built-module export claims. Replace unsupported runtime re-exports and code identifiers module/exports with direct ESM declarations, use unambiguous .mts generic syntax, and retain separate target-symbol evidence for type-only re-exports.",
