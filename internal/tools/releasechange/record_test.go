...
var currentAdditions = []Change{
	...
	{ChangeID: "proofkit.diagnostic-json-redaction", Summary: "Go report admission, repository-owned JavaScript diagnostics and the generated TypeScript adapter reject or redact secret-shaped quoted JSON pairs with repeated escaping before emitting output."},
}
