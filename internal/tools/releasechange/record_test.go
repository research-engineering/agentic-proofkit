...
var currentAdditions = []Change{
	...
	{ChangeID: "proofkit.diagnostic-json-redaction", Summary: "Go report admission, repository-owned JavaScript diagnostics and the generated TypeScript adapter reject or redact secret-shaped JSON pairs after repeated quote, whitespace or control-split escaping before emitting output."},
}
