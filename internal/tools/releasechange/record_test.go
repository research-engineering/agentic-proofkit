...
var currentAdditions = []Change{
	...
	{ChangeID: "proofkit.diagnostic-json-redaction", Summary: "Go report admission, repository-owned JavaScript diagnostics and the generated TypeScript adapter reject or redact secret-shaped JSON pairs with repeated quote and whitespace escaping before emitting output."},
}
